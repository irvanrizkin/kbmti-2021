<div class="department__top__tab-content tab-content mb-5" id="nav-tabContent">
    ...
    <div class="tab-pane fade show" id="list-bpmti" role="tabpanel" aria-labelledby="list-bpmti-list">
        <div class="department__top__tab-content__item d-flex button-subgroup-trigger-parent" id="button-subgroup-trigger-Non-Komisi">
            <img src="{{ asset('img/icon_1.svg') }}" alt="" width="48px">
            <a href="#" class="button-subgroup-trigger" data-subgroup="Non-Komisi" data-group="bpmti">Non-Komisi</a>
        </div>
        ...
        <div class="department__top__tab-content__item d-flex button-subgroup-trigger-parent" id="button-subgroup-trigger-Komisi-2">
            <img src="{{ asset('img/icon_3.svg') }}" alt="" width="48px">
            <a href="#" class="button-subgroup-trigger" data-subgroup="Komisi-2" data-group="bpmti">Komisi 2</a>
        </div>
        <div class="department__top__tab-content__item d-flex button-subgroup-trigger-parent" id="button-subgroup-trigger-Komisi-3">
            <img src="{{ asset('img/icon_4.svg') }}" alt="" width="48px">
